#############################################################
##### ADVERSARIAL VARIATIONAL BAYES for classification  #####
#############################################################
...
def main(permutation, split, layers):
    ...
    with tf.Session(config = config) as sess:
        ...
        for epoch in range(n_epochs):
            ...
            string = ('AVB - batch %g datetime %s epoch %d ELBO %g CROSS-ENT %g KL %g cpu_time %g ' + \
        ...
        np.savetxt('res_avb/results_error_' + str(split) + '.txt', [ error_class ])
        np.savetxt('res_avb/results_ll_' + str(split) + '.txt', [ TestLL ])
        np.savetxt('res_avb/results_raw_Brier_' + str(split) + '.txt', raw_brier_results)
        np.savetxt('res_avb/results_mean_Brier_' + str(split) + '.txt', [ mean_brier_results ])
